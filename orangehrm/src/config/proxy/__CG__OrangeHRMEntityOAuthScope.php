 ...
 */
class OAuthScope extends \OrangeHRM\Entity\OAuthScope implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\OAuthScope' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\OAuthScope' . "\0" . 'scope', '' . "\0" . 'OrangeHRM\\Entity\\OAuthScope' . "\0" . 'isDefault'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OAuthScope $proxy) {
